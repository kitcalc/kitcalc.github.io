...
function iso7064mod37_1140850840(s_1140850841) {
  var result_1140850842 = 0;
    ...
    Label1: {
      var c_1140850850 = 0;
      var i_570425762 = 0;
      var L_570425763 = (s_1140850841).length;
      Label2: {
          Label3: while (true) {
          if (!(i_570425762 < L_570425763)) break Label3;
            c_1140850850 = s_1140850841[chckIndx(i_570425762, 0, (s_1140850841).length - 1)];
            ...
            if (!(((s_1140850841).length == L_570425763))) {
    ...
    Label2: {
      ...
      Label3: {
          ...
          if (!(res_570425771 <= 11)) break Label4;
            m_1140850747 = chckRange(res_570425771, 0, 11);
